...
<html>
	<head>
		<title>Add New User | Support Ticket System</title>
		<meta charset="utf-8" />
		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Main -->
					<section id="main">
						<header>
							<h1>Add New User | Support Ticket System</h1>
						</header>
						
						<hr />
							<form method="POST" action="adminUpdate.php">
								<input type="hidden" name="UpdateType" value="NewUser">
								<input type="text" name="UserTitle" placeholder="Name" required=""><br />
